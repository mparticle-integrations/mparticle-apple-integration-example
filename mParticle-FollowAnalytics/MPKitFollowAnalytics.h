...
static NSString *FollowAnalyticsAPIKey = @"apiKey";
static NSString *FollowAnalyticsAppGroup = @"sharedGroupID";
static NSString *FollowAnalyticsDebugMode = @"debugMode";

@interface MPKitFollowAnalytics : NSObject <MPKitProtocol>
